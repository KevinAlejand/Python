...
pygame.init()
pygame.mixer.music.load(r'C:\Users\Kevin Alejandro\Downloads\merrygo.ogg')
...
def menuInicio():
    while True:
        ...
        # Mostrar nombres y grupo
        mostrarTexto("Desarrollado por:", fuente, COLOR_TEXTO, ventana, 150, 330)
        mostrarTexto("Ricardo Valenzuela y Kevin Solorzano", fuente, COLOR_TEXTO, ventana, 150, 360)
        mostrarTexto("Grupo: 432", fuente, COLOR_TEXTO, ventana, 150, 390)
...
palabras = [
    ...
    {"palabra": "arbol", "descripcion": "Planta grande con tronco y ramas", "pista": "Da sombra y oxígeno"},
